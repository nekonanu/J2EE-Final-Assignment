...
<fieldset>
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <c:if test="${userInfoRecord.vipCard.status=='freeze'}">
                <input type="email" class="input-xlarge uneditable-input alert" disabled="true" id="isActive"  value="未激活"/>
            </c:if>
            <c:if test="${userInfoRecord.vipCard.status=='activate'}">
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <input type="email" class="input-xlarge uneditable-input" disabled="true" id="cutoff"  value="${userInfoRecord.vipCard.cutoff}"/>
        </div>
    </div>
    <div class="control-group">
